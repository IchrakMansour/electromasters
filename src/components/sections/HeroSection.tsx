          ...
          {showCta && (
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-6 py-3 text-base font-semibold text-white shadow-lg transition hover:bg-[#1ebe5d] active:scale-95"
              >
