  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <a
        ...
        className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#1ebe5d] active:scale-95"
      >
